...
// TimbreEditor.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CTimbreEditorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CTimbreEditorApp の構築

CTimbreEditorApp::CTimbreEditorApp()
{
...
// 唯一の CTimbreEditorApp オブジェクト

CTimbreEditorApp theApp;


// CTimbreEditorApp の初期化

BOOL CTimbreEditorApp::InitInstance()
{
